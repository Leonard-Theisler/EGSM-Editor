...
public class MetaModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MetaModelPackage.DATA_FLOW_GUARD: {
			dataFlowGuard dataFlowGuard = (dataFlowGuard) theEObject;
			T result = casedataFlowGuard(dataFlowGuard);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MetaModelPackage.PROCESS_FLOW_GUARD: {
			processFlowGuard processFlowGuard = (processFlowGuard) theEObject;
			T result = caseprocessFlowGuard(processFlowGuard);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case MetaModelPackage.FAULT_LOGGER: {
			faultLogger faultLogger = (faultLogger) theEObject;
			T result = casefaultLogger(faultLogger);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>data Flow Guard</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>data Flow Guard</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casedataFlowGuard(dataFlowGuard object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>process Flow Guard</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>process Flow Guard</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseprocessFlowGuard(processFlowGuard object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>fault Logger</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>fault Logger</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casefaultLogger(faultLogger object) {
		return null;
	}
